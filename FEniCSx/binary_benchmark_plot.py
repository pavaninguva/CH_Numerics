...
# tvals1, phi_max1, phi_min1, phi_avg1, energy_vals1 = cahn_hilliard_analytical(initial_condition,chi=6,N1=1,N2=1,stride=10,tend=50,deltax=0.4,dt=0.1,return_data=True, return_vtk=False)
# tvals2, phi_max2, phi_min2, phi_avg2, energy_vals2 = cahn_hilliard_analytical(initial_condition,chi=6,N1=1,N2=1,stride=10,tend=50,deltax=0.2,dt=0.05,return_data=True, return_vtk=False)
# tvals3, phi_max3, phi_min3, phi_avg3, energy_vals3 = cahn_hilliard_analytical(initial_condition,chi=6,N1=1,N2=1,stride=10,tend=50,deltax=0.1,dt=0.025,return_data=True, return_vtk=False)
...
# tvals1_spline, phi_max1_spline, phi_min1_spline, phi_avg1_spline, energy_vals1_spline = cahn_hilliard_spline(initial_condition,chi=6,N1=1,N2=1,stride=10,tend=50,deltax=0.4,dt=0.1,return_data=True, return_vtk=False)
# tvals2_spline, phi_max2_spline, phi_min2_spline, phi_avg2_spline, energy_vals2_spline = cahn_hilliard_spline(initial_condition,chi=6,N1=1,N2=1,stride=10,tend=50,deltax=0.2,dt=0.05,return_data=True, return_vtk=False)
# tvals3_spline, phi_max3_spline, phi_min3_spline, phi_avg3_spline, energy_vals3_spline = cahn_hilliard_spline(initial_condition,chi=6,N1=1,N2=1,stride=10,tend=50,deltax=0.1,dt=0.025,return_data=True, return_vtk=False)
